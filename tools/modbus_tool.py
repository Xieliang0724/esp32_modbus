...
<div class="wrap">
  ...
  <div class="sub">寄存器映射：线圈 0x0000（DO0-3）· 离散输入 0x1000（DI0-6，0x1004/05 急停实时、0x1006 复位）· 输入寄存器 0x3000（0x3000 急停状态锁存、0x3001/02 急停实时、0x3003 复位、0x3004+ 设备信息）· 保持寄存器 0x4000（参数）</div>
</div>
...
function desc(idx, addr, val){
  ...
  var map = {
    ...
    0x1004:'DI4 急停1（实时）', 0x1005:'DI5 急停2（实时）', 0x1006:'DI6 复位按钮', 0x1007:'DI7 未使用',
